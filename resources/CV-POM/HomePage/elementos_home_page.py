...
#Reels Home
    ...
    "home_carrusel_recomienda": "xpath=//section[@class='section-carrousel section-recommended horizontal']",
    ...
    "home_carrrusel_Cviendo":"xpath=//div[contains(@class, 'pull-left') and contains(., 'Continúa viendo')]",
    ...
    "home_starzplay": "xpath=//h4[normalize-space()='LIONSGATE+']",
